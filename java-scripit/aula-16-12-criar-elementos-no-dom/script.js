...
//laço de repetição copiando do array

for(let i=0; 1  < arrayPostagens.length; i++ ){
    //criar elemento

    const article_Novo = document.createElement('article')


    //inserido id novo elemnto criado 

    article_Novo.innerHTML=`
    ...
    const main = document.querySelector('main');  // capturando main para inserir article_novo

    main.appendChild(article_Novo)
 ...
 //article_Novo.id= 'Post-2'

 // popular o elemento e inserir informação atraves do  array
